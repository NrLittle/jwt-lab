  ...
  return (
    <div className="app">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <p>Signed in as: <strong>{user.email}</strong> (role: {user.role})</p>
      ...
      <pre style={{ background: '#0d1117', padding: '1rem', borderRadius: '8px',
        fontSize: '0.75rem', wordBreak: 'break-all', whiteSpace: 'pre-wrap' }}>
        {token}
      </pre>
